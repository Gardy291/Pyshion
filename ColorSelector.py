class ColorSelector(object):
    ...
    def triad(color):
        ...
        return ColorSelector.colorArray[(index+4)%len(ColorSelector.colorArray)] +' and '+ ColorSelector.colorArray[(index+len(ColorSelector.colorArray)-4)%len(ColorSelector.colorArray)]
    ...
    def splitComplements(color):
        index = ColorSelector.indexFinder(color)
        return ColorSelector.colorArray[(index+5)%len(ColorSelector.colorArray)] +' and '+ ColorSelector.colorArray[(index+7)%len(ColorSelector.colorArray)]
